...
# Настройки бонусов
POWERUP_HEALTH_CHANCE_STRONG = 0.20
POWERUP_HEALTH_CHANCE_NORMAL = 0.20
POWERUP_FIRE_CHANCE_STRONG = 0.20
POWERUP_FIRE_CHANCE_NORMAL = 0.20
POWERUP_DAMAGE_CHANCE_STRONG = 0.20
POWERUP_DAMAGE_CHANCE_NORMAL = 0.20
POWERUP_BLAST_CHANCE_STRONG = 0.20
POWERUP_BLAST_CHANCE_NORMAL = 0.20
POWERUP_SPEED = 3
POWERUP_HEALTH_COLOR = (0, 255, 0)
POWERUP_FIRE_COLOR = (255, 255, 0)
POWERUP_DAMAGE_COLOR = (255, 0, 255)  # Фиолетовый цвет для бонуса силы
POWERUP_BLAST_COLOR = (0, 255, 255)   # Голубой цвет для бонуса мощной атаки
POWERUP_SIZE = 30
FIRE_RATE_BOOST = 10
