...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, x, y, vel_y, color, vel_x=0, width=4, height=10, damage=1):
        super().__init__()
        ...
        self.vel_x = vel_x
        self.vel_y = vel_y
        self.damage = damage  # Урон от пули
    ...
    def player_bullet(cls, player_rect):
        from utils.constants import bullet_color, bullet_speed, player_bullet_damage
        return cls(player_rect.centerx - 2, player_rect.top, -bullet_speed, bullet_color, 0, 4, 10, player_bullet_damage)
    ...
    def reset(self, x=None, y=None, vel_y=None, color=None, vel_x=None, width=None, height=None, damage=1):
        ...
        if vel_y is not None:
            self.vel_y = vel_y
        self.damage = damage  # Урон по умолчанию 1
